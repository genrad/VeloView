...
//-----------------------------------------------------------------------------
bool vtkRadarPacketInterpreter::SplitFrame(bool force)
{
...
//-----------------------------------------------------------------------------
bool vtkRadarPacketInterpreter::shouldBeCroppedOut(double pos[3], double theta)
{
...
//-----------------------------------------------------------------------------
vtkCxxSetObjectMacro(vtkRadarPacketInterpreter, SensorTransform, vtkTransform)

//-----------------------------------------------------------------------------
vtkMTimeType vtkRadarPacketInterpreter::GetMTime()
{
